...
func setupRoutes(api *echo.Group) {
	...
	g.Delete("/:group/users/:user", addUserToGroupHandler)
	g.Post("/:group/datacenters/", deleteDatacenterFromGroupHandler)
	g.Delete("/:group/datacenters/:user", deleteDatacenterFromGroupHandler)
